...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick, ind}) => {
  const remainingDays = daysLeft(deadline);

  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer fund-card" onClick={handleClick}>
      <img src={ ind === 0 ? 'https://cdn.techjuice.pk/wp-content/uploads/2020/10/crowdfunding-pak.png': image} alt="fund" className="w-full h-[158px] object-cover rounded-[15px]"/>
